...
Humble | Garden | 13.x | [iron](https://github.com/ros/sdformat_urdf/tree/iron) | only from source
Humble | Harmonic | 14.x | [rolling](https://github.com/ros/sdformat_urdf/tree/rolling) | only from source
Iron | Fortress | 12.x | [humble](https://github.com/ros/sdformat_urdf/tree/humble) | https://packages.ros.org
Iron | Garden | 13.x | [iron](https://github.com/ros/sdformat_urdf/tree/iron) | only from source
Iron | Harmonic | 14.x | [rolling](https://github.com/ros/sdformat_urdf/tree/rolling) | only from source
Jazzy | Garden | 13.x | [iron](https://github.com/ros/sdformat_urdf/tree/iron) | only from source
Jazzy | Harmonic | 14.x | [rolling](https://github.com/ros/sdformat_urdf/tree/rolling) | https://packages.ros.org
Rolling | Fortress | 12.x | [humble](https://github.com/ros/sdformat_urdf/tree/humble) | https://packages.ros.org
Rolling | Garden | 13.x | [iron](https://github.com/ros/sdformat_urdf/tree/iron) | only from source
